...
public class ResultsCard extends JPanel
{
    ...
    public void paintScore(Graphics g)
    {
        ...
        {
            g.drawString("You are a failure at life and you should give up!", 220, 350);
        }
        ...
        else if(gamCard.score >= 400 && gamCard.score < 4000)
        {
            g.drawString("You are very good at this game!", 220, 350);
        }
        else if(gamCard.score == 4000)
        {
            g.drawString("No frickin way! This is the highest possible score in the entire game!", 220, 350);
        }
        else if(gamCard.score > 4000)
        {
            g.drawString("You somehow hacked my game in a way where you could get more points than the maximum.", 220, 350);
        }
    }
}
